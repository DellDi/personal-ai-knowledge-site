...
export const ui = {
  'zh-CN': {
    ...
    adminStatusGuide: '设置 CMS_API_URL 后，会在本地 MDX 基础上叠加 CMS 已发布内容；CMS 不可达时保留本地内容。',
    relatedTitle: '相关内容',
  ...
  en: {
    ...
    adminStatusGuide: 'Set CMS_API_URL to layer published CMS content on top of local MDX. Local content remains when CMS is unreachable.',
